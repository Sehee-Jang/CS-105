...
public class lab8i {
	...
	public static void main(String[] args) {
		...
		while (playAgain.equalsIgnoreCase("Y")) {
			...
			System.out.println("The duplicates in the arraylist are: ");
			for(int i=0; i < dups(numbers).size(); i++) {
				System.out.print(dups(numbers).get(i));
			}
	...
	public static ArrayList<Integer> dups(ArrayList<Integer> myList) {
		...
		//.subList(1,arraylist.size()-1)
		
		//.contains(7) - true or false
		
		for(int i = 0; i < myList.size(); i++) {
			
			// if an element in myList is a duplicate and also isn't currently in my duplicate array list, then add this element to duplicates.
